...
public class CutBillToppingOrderAdapter extends RecyclerView.Adapter<CutBillToppingOrderAdapter.ViewHolder> {
    private Context context;
    RealmList<ToppingOrder> toppings;
    ChooseFoodClickInterface chooseFoodClickInterface;
    FoodOrder foodOrder;
    public CutBillToppingOrderAdapter(Context context, RealmList<ToppingOrder> toppings, ChooseFoodClickInterface chooseFoodClickInterface, FoodOrder foodOrder) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View rootView = inflater.inflate(R.layout.adapter_cutbill_food_order_topping, null, false);
...
//                    chooseFoodClickInterface.toppingClick(foodOrder);
                }
            });
        }
    }
