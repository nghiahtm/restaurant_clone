...
public class ViewHolder_Trash extends RecyclerView.ViewHolder{
    List<TrashItem> mData;
    ...
    public ViewHolder_Trash(@NonNull View itemView, List<TrashItem> data, ITrashTableClick onClickInterface) {
        super(itemView);
        mData = data;
